...
from vivarium_gates_bep.utilites import sample_beta_distribution, sample_normal_distribution
...
IFA_COVERAGE_VARIANCE = {location: twenty_percent_of_mean_variance(mean)
                         for location, mean in IFA_COVERAGE_MEAN.items()}
...
# These shifts started out as different values... Feedback from BMGF after several iterations settled on 
#  no difference. It is simpler at this point to have 2 sets of identical values.
...
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_MEAN = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_MEAN
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_LOWER = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_LOWER
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_UPPER = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_UPPER
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_LOWER_BOUND = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_LOWER_BOUND
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_UPPER_BOUND = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_UPPER_BOUND
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_VARIANCE = BEP_CE_BIRTH_WEIGHT_SHIFT_SIZE_NORMAL_VARIANCE
...
CRUDE_BW_SHIFT = 138.46
CRUDE_BW_SHIFT_UPPER = 174.68
CRUDE_BW_SHIFT_LOWER = 102.25
CRUDE_BW_SHIFT_SD = (CRUDE_BW_SHIFT_UPPER - CRUDE_BW_SHIFT_LOWER) / (2 * 1.96)


BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_MALNOURISHED_MEAN = 136
BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_MALNOURISHED_SD = 29
...
BEP_BIRTH_WEIGHT_SHIFT_SIZE_MALNOURISHED = {
    EFFECT_CURRENT_EVIDENCE: {
        'distribution': sample_beta_distribution,
        'parameters': {
    ...
    EFFECT_HOPES_AND_DREAMS: {
        'distribution': sample_normal_distribution,
        'parameters': {
            'mean': BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_MALNOURISHED_MEAN,
            'sd': BEP_HD_BIRTH_WEIGHT_SHIFT_SIZE_MALNOURISHED_SD
        }
    }
}
...
Z_SCORE_TIMEPOINTS = ('twenty_nine_days', 'three_six_six_days')
TWENTY_NINE_DAYS = 0.07939767282683094
THREE_SIX_SIX_DAYS = 1.002053388090349
...
Z_SCORE_COLUMNS = '{CGF_RISK}_z_score_{STATS_MEASURE}_at_{Z_SCORE_TIMEPOINT}_mother_{MALNOURISHMENT_CATEGORY}_treatment_{TREATMENT_CATEGORY}'
CATEGORY_COUNT_COLUMNS = '{CGF_RISK}_{RISK_CATEGORY}_exposed_at_{Z_SCORE_TIMEPOINT}_mother_{MALNOURISHMENT_CATEGORY}_treatment_{TREATMENT_CATEGORY}'
...
TEMPLATE_FIELD_MAP = {
    ...
    'Z_SCORE_TIMEPOINT': Z_SCORE_TIMEPOINTS,
}
