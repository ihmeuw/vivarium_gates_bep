...
class CorrelatedRisk(Risk):
    ...
    def setup(self, builder):
        ...
        self.exposure = builder.value.register_value_producer(
            ...
            requires_values=[propensity_col],
            preferred_post_processor=get_exposure_post_processor(builder, self.risk)
        )

        self.population_view = builder.population.get_view([propensity_col, birth_weight_propensity_col])
        builder.population.initializes_simulants(self.on_initialize_simulants,
                                                 creates_columns=[propensity_col],
                                                 requires_columns=[project_globals.BIRTH_WEIGHT, birth_weight_propensity_col],
